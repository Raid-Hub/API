...
export const getAtlasPGCR = async (): Promise<AtlasStatus> => {
...
export const getFloodgatesPGCR = async (): Promise<FloodgatesStatus> => {
    ...
    const backlog = floodgatesStatus.total
    ...
    if (backlog > 100) {
        ...
        status =
            ...
            floodgatesStatus.ackRateSeconds / 2 > floodgatesStatus.ingressRateSeconds
                ? "Live"
                : "Blocked"
    } else if (
        backlog === 0 &&
